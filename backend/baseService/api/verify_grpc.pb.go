...
const (
	AuthService_CreateVerificationCode_FullMethodName   = "/api.AuthService/CreateVerificationCode"
	AuthService_ValidateVerificationCode_FullMethodName = "/api.AuthService/ValidateVerificationCode"
)
