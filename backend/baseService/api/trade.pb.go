...
var file_trade_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x32, 0x5a, 0x30, 0x44, 0x6f, 0x75, 0x54, 0x6f, 0x6b, 0x2d, 0x65, 0x78, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x62, 0x61, 0x73, 0x65,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65,
...
type TradeService interface {
	QueryTradeOrder(ctx context.Context, req *QueryTradeOrderRequest) (res *QueryTradeOrderResponse, err error)
	TradeCreate(ctx context.Context, req *TradeCreateRequest) (res *TradeCreateResponse, err error)
	MergeTrade(ctx context.Context, req *MergeTradeRequest) (res *MergeTradeResponse, err error)
	UpdateExtendInfo(ctx context.Context, req *UpdateExtendInfoRequest) (res *UpdateExtendInfoResponse, err error)
	UpdateTradeOrderStatus(ctx context.Context, req *UpdateTradeOrderStatusRequest) (res *UpdateTradeOrderStatusResponse, err error)
	UpdateDeliveryInfo(ctx context.Context, req *UpdateDeliveryInfoRequest) (res *UpdateDeliveryInfoResponse, err error)
	AddSubOrder(ctx context.Context, req *AddSubOrderRequest) (res *AddSubOrderResponse, err error)
}
