...
type DeliveryInfo struct {
	...
	Extra           map[string]string      `protobuf:"bytes,8,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 额外信息
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type TradeOrder struct {
	...
	Extra              map[string]string      `protobuf:"bytes,27,rep,name=extra,proto3" json:"extra,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`          // 额外信息
...
var file_trade_entities_proto_rawDesc = string([]byte{
...
var (
	...
	file_trade_entities_proto_rawDescData []byte
)

func file_trade_entities_proto_rawDescGZIP() []byte {
	file_trade_entities_proto_rawDescOnce.Do(func() {
		file_trade_entities_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_trade_entities_proto_rawDesc), len(file_trade_entities_proto_rawDesc)))
	})
...
var file_trade_entities_proto_goTypes = []any{
...
func file_trade_entities_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_trade_entities_proto_rawDesc), len(file_trade_entities_proto_rawDesc)),
			NumEnums:      17,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
