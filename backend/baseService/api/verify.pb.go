...
type AuthService interface {
	CreateVerificationCode(ctx context.Context, req *CreateVerificationCodeRequest) (res *CreateVerificationCodeResponse, err error)
	ValidateVerificationCode(ctx context.Context, req *ValidateVerificationCodeRequest) (res *ValidateVerificationCodeResponse, err error)
}
