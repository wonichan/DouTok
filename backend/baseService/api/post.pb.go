...
var file_post_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x32, 0x5a, 0x30, 0x44, 0x6f, 0x75, 0x54, 0x6f, 0x6b, 0x2d,
	0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f,
	0x62, 0x61, 0x73, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x6b, 0x69, 0x74, 0x65,
...
type PostService interface {
	CreateTemplate(ctx context.Context, req *CreateTemplateRequest) (res *CreateTemplateResponse, err error)
	UpdateTemplate(ctx context.Context, req *UpdateTemplateRequest) (res *UpdateTemplateResponse, err error)
	ListTemplate(ctx context.Context, req *ListTemplateRequest) (res *ListTemplateResponse, err error)
	GetTemplate(ctx context.Context, req *GetTemplateRequest) (res *GetTemplateResponse, err error)
	RemoveTemplate(ctx context.Context, req *RemoveTemplateRequest) (res *RemoveTemplateResponse, err error)
	SendSms(ctx context.Context, req *SendSmsRequest) (res *SendSmsResponse, err error)
	SendEmail(ctx context.Context, req *SendEmailRequest) (res *SendEmailResponse, err error)
	Send(ctx context.Context, req *SendRequest) (res *SendResponse, err error)
}
